...
function Button2_onclick() {
    var data = document.getElementById("CSSCARDCtrl").iReadCardBas(1);
    var pOutInfo = document.getElementById("CSSCARDCtrl").pOutInfo;
    console.log(pOutInfo);
    var myAry = [];
    myAry = pOutInfo.split("|");
    return myAry;
}