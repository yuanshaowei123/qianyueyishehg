...
(function (factory) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group">' +
                 ...
                 (!options.disableLinkTarget ?
                   '<div class="checkbox">' +
                     '<label class="mt-checkbox" style="padding-left: 25px;">' + '<input type="checkbox" checked> ' + lang.link.openInNewWindow + '<span></span></label>' +
                   '</div>' : ''
                 );
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      fontNames: [
        '黑体','仿宋','方正舒体','方正姚体 ','华文彩云','华文行楷','华文琥珀 ','楷体','华文新魏','幼圆','Arial', 'Arial Black', 'Comic Sans MS', 'Courier New',
