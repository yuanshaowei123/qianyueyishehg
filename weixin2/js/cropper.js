...
var render = {
  ...
  initCropBox: function initCropBox() {
    ...
    cropBox.width = Math.max(cropBox.minHeight, cropBox.height * autoCropArea);
  ...
  createClass(Cropper, [{
    ...
    value: function init() {
      ...
      if ($element.is('img')) {
        ...
        // Should use `$.fn.prop.vue` here. e.g.: "http://example.com/img/picture.jpg"
