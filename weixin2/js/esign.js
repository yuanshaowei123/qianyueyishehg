...
(function (root, doc, factory) {
    ...
    $.fn.esign = function (canvasEdit, sign_show, sign_clear, sign_ok) {
        ...
        function onMouseMove(evt) {
            ...
            evt.preventDefault();
            hasDrawImage = "true";
            show.setAttribute("data-hasDrawImage", hasDrawImage);
        }
        ...
        function rewrite() {
            ...
            hasDrawImage = "false";
            show.setAttribute("data-hasDrawImage", hasDrawImage);
            show.setAttribute("data-imgBase64", "");
        }
        ...
        function preview() {
            var show = domMap.sign_show[0];
            show.innerHTML = "";
            if(hasDrawImage!=="false"){
                show.setAttribute("data-imgBase64", convertCanvasToImage(canvas).src);
            }
        }
